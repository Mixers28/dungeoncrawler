...
export default function SplashPage() {
  ...
  // Game state lives in Postgres — just navigate; page.tsx loads from DB
  const handleContinue = () => router.push('/')
  const handleNewRun = () => router.push('/?newRun=1')
  const handleViewLeaderboard = () => router.push('/landing')
