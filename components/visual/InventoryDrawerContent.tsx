        ...
        <div className="space-y-1.5" data-testid="quick-use-actions">
          {actions.map(action => (
            <button
              ...
              title={action.reason}
              className="w-full text-left px-3 py-2 rounded text-sm bg-slate-800 hover:bg-green-800/60 border border-slate-700 text-slate-100 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
              {action.label}
            </button>
          ))}
